...
function EditListing() {
  ...
  // Redirect if listing is not belong to the user
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const fetchListing = async () => {
      ...
      if (docSnap.exists()) {
        ...
        // Fill the form values with the fetched state:
        // Firestore: "location", FormState: "address" this is we need to do this:
  ...
  const onMutate = (e) => {
    ...
    if (!e.target.files) {
      setFormData((prevState) => ({
        ...prevState,
        // ?? operator -> if the value is nullish, use the value on the left
